    ...
    <section className="py-20 bg-gradient-subtle">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-card rounded-2xl shadow-medium p-8 border-2 border-primary/20 relative overflow-hidden">
            {/* Popular Badge */}
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="bg-gradient-secondary text-white px-6 py-2 rounded-full text-sm font-semibold flex items-center gap-2">
